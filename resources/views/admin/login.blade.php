...
<head>
  ...
  <link href="admin_css/https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i" rel="stylesheet">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user" action="login" method="POST">
                    ...
                    <a href="http://localhost/hungthinh/public/admin/tintuc/danhsach" class="btn btn-primary btn-user btn-block">
                      Đăng nhập
                    </a>
                    <hr>
                  </form>
